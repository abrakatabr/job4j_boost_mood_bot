...
public class Main {
    ...
    @Bean
    CommandLineRunner loadMoodDatabase(MoodRepository moodRepository, MoodContentRepository moodContentRepository) {
        return args -> {
            ...
            data.add(new MoodContent(new Mood("Легкое волнение \uD83C\uDF88", false),
